...
history = simplecdr.fit([smile_strings_train[:160000,:], drug_features_train[:160000,:], train_gcn_feats[:160000,:, :], train_adj_list[:160000,:, :], 
...
simplecdr.save("..//Models//simplecdr_proper_gcn_multi_gpu")

simplecdr = tf.keras.models.load_model("..//Models//simplecdr_proper_gcn_multi_gpu")
